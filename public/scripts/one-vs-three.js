...
function findWinner() {
  ...
  if (
    ...
    if ($(`td${identifyPlayer}57`).find("img").length >= 1) {
      ...
      if ($(`td.r57`).find("img").length < 1) {
        fourthWinner = $("#player-1-name").text();
        xOfFourth = 1;
      } else if ($(`td.b57`).find("img").length < 1) {
        fourthWinner = $("#player-2-name").text();
        xOfFourth = 2;
      } else if ($(`td.y57`).find("img").length < 1) {
        fourthWinner = $("#player-3-name").text();
        xOfFourth = 3;
      } else if ($(`td.g57`).find("img").length < 1) {
...
function fiveMergeCode() {
  ...
  let resultLocation4ExchH1 = undefined;
  let resultLocation4ExchH2 = undefined;
...
function computerHorse() {
  if (lastClick >= Date.now() - delay) {
    ...
    if (
      ...
      setTimeout(() => {
        if ($(`#player-${x}`).find("img").length != 0 && randomDice == 6) {
          computerHorsesAtDefault = $(`#player-${x} img`);
          ...
          computerHorsesAtDefault = $(`#player-${x} img`);
        } else if ($(`#player-${x}`).find("img").length == 0 || randomDice != 6) {
