...
(function () {
  ...
  function openLigandCardPopup(ligandId) {
    ...
    overlay.innerHTML = ''
      ...
      +       '<div class="w-full h-full bg-no-repeat" style="background-image:url(\'' + imgPath + '\'); background-position:0% center; background-size:215%;"></div>'
      ...
      +       '<div class="w-full h-full bg-no-repeat" style="background-image:url(\'' + imgPath + '\'); background-position:100% center; background-size:215%;"></div>'
